    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <!-- Button tambah anggota kepolisian -->
          <a href="tambah_anggota.php" class="btn btn-primary btn-icon-split mb-4">
              <span class="icon text-white-50">
                  <i class="fas fa-plus"></i>
                </span>
                <span class="text">Tambah Anggota Kepolisian</span>
            </a>
          <!-- DataTales -->
          <div class="card shadow mb-4">
            <div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">Daftar Anggota Kepolisian</h6>
            </div>
            <div class="card-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  include '../koneksi.php';
                  $no = 1;
                  $data = mysqli_query($koneksi,"SELECT * FROM anggota_polisi INNER JOIN pangkat ON anggota_polisi.id_pangkat = pangkat.id_pangkat
                  INNER JOIN jabatan ON anggota_polisi.id_jabatan = jabatan.id_jabatan");
                  while ($d = mysqli_fetch_array($data)) {
                    ...
                    <tr>
                      ...
                      <td><a class="btn btn-warning mr-2 btn-sm" href="edit_anggota.php?nrp=<?php echo $d['nrp']?>" role="button">Edit</a>
                      <a class="btn btn-danger mr-2 btn-sm" href="delete_anggota.php?nrp=<?php echo $d['nrp']?>"  role="button">Hapus</a>
                      </td>
                    </tr>
                  <?php
                  } ?>  
