    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          <!-- Page Heading -->
          <h1 class="h1 pt-5 mt-5 mb-1 text-gray-800 text-center">Sistem Penjadwalan Anggota Kepolisian</h1>
          <h2 class="h1 mb-1 text-gray-800 text-center">Polsek Magelang Tengah</h2>
          <h3 class="h3 mb-1 text-gray-800 text-center">Polres Magelang Kota</h3>
